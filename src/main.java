...
public class main  {
    public static void main(String[] args) throws InterruptedException {
        ...
        Spherical_stellar_object Sol = new Spherical_stellar_object(sol, sol_mass, "sun", 696340, 696000);
        Spherical_stellar_object Earth = new Spherical_stellar_object(earth, earth_mass, "earth", 6378, 6357, 24, 0, new double[]{0, 0});
        ...
        for (int i = 0; i < test.length; i++) {
            ...
            test[i] = new Sattelite(10, "s"+i, Earth2, lan, arg, ano, inc, 180000, 0.0);
